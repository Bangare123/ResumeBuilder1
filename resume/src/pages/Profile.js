...
import ExperienceProjectsAchievements from "../components/ExperienceProjects";
...
function Profile() {
  ...
  const user = JSON.parse(localStorage.getItem("ResumeNewDatabase-user"));
  const onFinish = async (values) => {
    ...
    try {
      ...
      localStorage.setItem("ResumeNewDatabase-user", JSON.stringify(result.data));
      setLoading(false);
